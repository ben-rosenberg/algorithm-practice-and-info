 ...
 */
 function roundToInterval(num, interval) {
    ...
    const whole = Math.floor(num / interval);
    const nearestSmaller = whole * interval;
    const nearestGreater = (whole + 1) * interval;

    return nearestGreater - num <= num - nearestSmaller ? nearestGreater : nearestSmaller; 
}
